...
class CreditControlCommunication(models.TransientModel):
    ...
    def _compute_account_careof_partner_id(self):
        self.account_careof_partner_id = self.partner_id\
            .get_account_careof_partner(self.report_date)
    ...
    @api.multi
    def get_email(self):
        if not self.account_careof_partner_id.id:
            email = super(CreditControlCommunication, self).get_email()
        else:
            email = self.account_careof_partner_id.email
        return email
